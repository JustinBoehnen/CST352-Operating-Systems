 ...
 *
 ************************************************************************/
int Q_Enqueue(queue_t queue, thread_t *thread);
 ...
 *
 ************************************************************************/
thread_t *Q_Dequeue(queue_t queue);
...
/**********************************************************************
 * Purpose: Indicates the number of items in the queue
 *
 * Precondition:
 *     Queue is a valid queue
 *
 * Postcondition:
 *      Returns int representing nuber of items in the queue
 *
 * Thread safety: Thread safe.
 *
 ************************************************************************/
